...
const char UNITY_PROGMEM UnityStrOk[] = "\033[32mOK\033[0m";     // Green text
const char UNITY_PROGMEM UnityStrPass[] = "\033[32mPASS\033[0m"; // Green text
const char UNITY_PROGMEM UnityStrFail[] = "\033[31mFAIL\033[0m"; // Red text
const char UNITY_PROGMEM UnityStrIgnore[] =
    "\033[33mIGNORE\033[0m"; // Yellow text
#else
